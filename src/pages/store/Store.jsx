      ...
      <section className="productsSec">
        <aside className="productsSec_products">
          <div className="productsSec_products_search">
            <input  className="productsSec_products_search_input" type="search" placeholder="Search" />
          ...
          <div className="productsSec_products_category">
            ...
            <ul className="productsSec_products_category_list">
              <li className="productsSec_products_category_list_item">
                <div className="productsSec_products_category_list_item_content">Dried </div>
                <span className="productsSec_products_category_list_item_count">6</span>
              </li>
              <li className="productsSec_products_category_list_item">
                <div className="productsSec_products_category_list_item_content">Vegetables </div>
                <span className="productsSec_products_category_list_item_count">8</span>
              </li>
              <li className="productsSec_products_category_list_item">
                <div className="productsSec_products_category_list_item_content">Fruits </div>
                <span className="productsSec_products_category_list_item_count">9</span>
              </li>
              <li className="productsSec_products_category_list_item">
                <div className="productsSec_products_category_list_item_content">Juice </div>
                <span className="productsSec_products_category_list_item_count">6</span>
              </li>
              <li className="productsSec_products_category_list_item">
                <div className="productsSec_products_category_list_item_content">Uncategorized</div>
                <span className="productsSec_products_category_list_item_count">1</span>
              </li>
            </ul>
          </div>
          ...
          <div className="productsSec_products_filter_price">
            <button className="productsSec_products_filter_price_btn">Filter</button>
            <span className="productsSec_products_filter_price_cost">Price: $0 - $75</span>
          </div>
          </div>
          ...
          <ul className="productsSec_products_topRare_list">
            <li className="productsSec_products_topRare_list_item">
              ...
              <div className="productsSec_products_topRare_list_item_desc">
                ...
                <p className="productsSec_products_topRare_list_item_desc_money">21.00$</p>
              </div>
              </li>
            <li className="productsSec_products_topRare_list_item">
            <div className="productsSec_products_topRare_list_item_img">
        ...
        <aside className="productsSec_products_cards">
          <div className="productsSec_products_cards_nav">
            ...
            <div className="productsSec_products_cards_nav_sorting">
              <label className="productsSec_products_cards_nav_sorting_name" > Sort by:</label>
